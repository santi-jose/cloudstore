...
# query to create the client table
create_client_table = """
    CREATE TABLE client (
...
# query to create the participant table
...
# define relationships between participant and course tables
...
# QUERY TO FIX TYPO REGARDING TEACHER_ID = 2 TAX_ID
update2 = """
UPDATE teacher
SET tax_id = 23456
WHERE teacher_id = 2;
...
# execute_query(connection, update2)
...
# look at the courses we have in our database
# q1 = """
# SELECT *
# FROM course;
# """
